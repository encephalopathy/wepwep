...
local function onBuyButtonRelease()
	...
	storyboard.gotoScene( "com.shopmenu.MenuBuy", "fade", 500 )
	return true	-- indicates successful touch
end

local function onSellButtonRelease()
	storyboard.gotoScene("com.shopmenu.MenuSell", "fade", 500)
	return true
end
...
function scene:enterScene( event )
	local group = self.view
	playBGM("com/resources/music/bgmusic/shopMusic.ogg")
