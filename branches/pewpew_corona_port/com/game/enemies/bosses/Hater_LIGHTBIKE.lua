...
function Hater_LIGHTBIKE:init(sceneGroup)
	self.super:init(sceneGroup, "com/resources/art/sprites/boss_03.png", 0, 0, 0, 100, 100)
...
function Hater_LIGHTBIKE:__tostring()
	return 'com.game.enemies.Hater_LIGHTBIKE'
end
