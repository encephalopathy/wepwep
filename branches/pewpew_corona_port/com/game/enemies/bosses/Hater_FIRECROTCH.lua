require "com.enemies.Hater"

--[[
	A dead, fed, red machine. His power is maximum!
]]--
...
function Hater_FIRECROTCH:init(sceneGroup)
	self.super:init(sceneGroup, "com/resources/art/sprites/boss_02.png", 0, 0, 0, 100, 100)
...
function Hater_FIRECROTCH:initMuzzleLocations()
...
function Hater_FIRECROTCH:__tostring()
	return 'com.game.enemies.Hater_FIRECROTCH'
end

return Hater_FIRECROTCH