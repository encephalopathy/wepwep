...
--setting = NRML: this sound does not have a specified behavior and will seek out a free channel to play on
 gameSFXInfo = {
	...
	Randomshot = {path = "com/resources/music/soundfx/shotgun.ogg", channel = 2, setting = 'R'},
	SpiralStraightshot = {path = "com/resources/music/soundfx/laser.ogg", channel = 2, setting = 'R'},
	SpiralCurveshot = {path = "com/resources/music/soundfx/shotgun.ogg", channel = 2, setting = 'R'},
	Circleshot = {path = "com/resources/music/soundfx/shotgun.ogg", channel = 2, setting = 'R'},
	Backshot = {path = "com/resources/music/soundfx/shotgun.ogg", channel = 2, setting = 'R'},
	Bomb = {path = "com/resources/music/soundfx/shotgun.ogg", channel = nil, setting = 'NRML'},
	Hater_die = {path = "com/resources/music/soundfx/enemyDeath.ogg", channel = 3, setting = 'R'},
