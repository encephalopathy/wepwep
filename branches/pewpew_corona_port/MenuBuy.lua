...
function BuyMenu.onCreate()
	...
	denyText = RNFactory.createText("Sorry, you can't afford that", { size = 25, top = 2005, left = 2005, parentGroup = sceneGroup, width = 200, height = 50 })
	sceneGroup:insert(denyText)
	
		local equipText = RNFactory.createBitmapText("BUY MENU", {
	...
	sceneGroup:insert(equipText)
		...
		ammo = RNFactory.createButton("images/button-plain.png",
        {
            text = "Buy Ammo - 50 " .. mainInventory.SecondaryWeapons[1].ammo .. " left",
            parentGroup = sceneGroup,
            imageOver = "images/button-over.png",
            font = "dwarves.TTF",
            top = 400,
	...
	storeSound = MOAIUntzSound.new()
	purchasePath = 'moneySFX.ogg'
...
function setThingsUp()
	if mainInventory.permission[1] then regularshot.x = 5000
	else regularshot.x = 150 end
	if mainInventory.permission[2] then spreadshot.x = 5000 
	else spreadshot.x = 150 end
	if mainInventory.permission[3] then sineshot.x = 5000 
	else sineshot.x = 150 end
	if mainInventory.permission[5] then doubleshot.x = 5000 
	else doubleshot.x = 280 end
	if mainInventory.permission[4] then homingshot.x = 5000 
	else homingshot.x = 280 end
	if mainInventory.permission[6] then end
	if mainInventory.permission[7] then end
	button3.x = 225
	pauseScreen.x = 4000
		pauseScreen.y = 900
...
function yes(event)
  ...
  if (weapon == "regular") then
	...
	regularshot.x = 5000
	mainInventory.dollaz = mainInventory.dollaz - regularshot.cost
	yesButton.x = 1000
	yesButton.y = 3000		
  ...
  if (weapon == "spread") then
	...
	spreadshot.x = 5000
	mainInventory.dollaz = mainInventory.dollaz - spreadshot.cost
	yesButton.x = 1000
	yesButton.y = 3000		
  ...
  if (weapon == "sine") then
	...
	sineshot.x = 5000
	mainInventory.dollaz = mainInventory.dollaz - sineshot.cost
	yesButton.x = 1000
	yesButton.y = 3000		
	...
	doubleshot.x = 5000
	mainInventory.dollaz = mainInventory.dollaz - doubleshot.cost
	yesButton.x = 1000
	yesButton.y = 3000		
	...
	homingshot.x = 5000
	mainInventory.dollaz = mainInventory.dollaz - homingshot.cost
	yesButton.x = 1000
	yesButton.y = 3000		
...
function confirmPurchaseRegular(event)
	...
	if (mainInventory.dollaz >= regularshot.cost) then
		...
		confirmText.text = "Purchase ".. weapon .. " for " .. regularshot.cost .. " dollaz?"
		confirmText.x = 120
		confirmText.y = 120		
	else
		okButton.x = 200
...
function confirmPurchaseSpread(event)
	...
	if (mainInventory.dollaz >= spreadshot.cost) then
		yesButton.x = 100
		yesButton.y = 300		
		...
		confirmText.text = "Purchase ".. weapon .. " for " .. spreadshot.cost .. " dollaz?"
		confirmText.x = 200
		confirmText.y = 200		
	else
		okButton.x = 200
...
function confirmPurchaseSine(event)
	...
	if (mainInventory.dollaz >= sineshot.cost) then
		yesButton.x = 100
		yesButton.y = 300		
		...
		confirmText.text = "Purchase ".. weapon .. " for " .. sineshot.cost .. " dollaz?"
		confirmText.x = 200
		confirmText.y = 200		
	else
		okButton.x = 200
...
function confirmPurchaseDouble(event)
	...
	if (mainInventory.dollaz >= doubleshot.cost) then
		yesButton.x = 100
		yesButton.y = 300		
		...
		confirmText.text = "Purchase ".. weapon .. " for " .. doubleshot.cost .. " dollaz?"
		confirmText.x = 200
		confirmText.y = 200		
	else
		okButton.x = 200
...
function confirmPurchaseHoming(event)
	...
	if (mainInventory.dollaz >= homingshot.cost) then
		yesButton.x = 100
		yesButton.y = 300		
		...
		confirmText.text = "Purchase ".. weapon .. " for " .. homingshot.cost .. " dollaz?"
		confirmText.x = 200
		confirmText.y = 200		
	else
		okButton.x = 200
...
function confirmPurchaseAmmo(event)
	
	if (mainInventory.dollaz >= ammo.cost) then
		mainInventory.dollaz = mainInventory.dollaz - ammo.cost
		...
		--ammo.text = "Buy Ammo - 50 " .. mainInventory.SecondaryWeapons[1].ammo .. " left"
	else
		okButton.x = 200
		okButton.y = 300
		denyText.x = 200
