...
public class LaserRayCast : MonoBehaviour
{
    ...
    void RenderLaser()
    {
        ...
        for (int i = 0; i < length; i++)
        {
            ...
            //noise added to lasers to make it spasm
            ...
            offset.x = myTransform.position.x + i * myTransform.forward.x;
            offset.z = i * myTransform.forward.z + myTransform.position.z;
            position[i] = offset;
